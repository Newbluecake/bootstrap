...
// Cursor a cursor representing some element in the abstract syntax tree for
// a translation unit.
//
...
// GetCursorAvailability determine the availability of the entity that this cursor refers to,
...
// GetOverriddenCursors determine the set of methods that are overridden by the given
// method.
//
...
// GetCursorLocation retrieve the physical location of the source constructor referenced
// by the given cursor.
//
...
// GetCursorExtent retrieve the physical extent of the source construct referenced by
// the given cursor.
//
...
// GetEnumConstantDeclValue retrieve the integer value of an enum constant declaration as a signed
// long long.
//
...
// GetEnumConstantDeclUnsignedValue retrieve the integer value of an enum constant declaration as an unsigned
// long long.
//
...
// NumArguments retrieve the number of non-variadic arguments associated with a given
// cursor.
//
...
// TemplateArgumentValue retrieve the value of an Integral TemplateArgument (of a function
...
// TemplateArgumentUnsignedValue retrieve the value of an Integral TemplateArgument (of a function
...
// GetCursorExceptionSpecificationType retrieve the exception specification type associated with a given cursor.
...
// GetNumOverloadedDecls determine the number of overloaded declarations referenced by a
...
// GetOverloadedDecl retrieve a cursor for one of the overloaded declarations referenced
...
// GetIBOutletCollectionType for cursors representing an iboutletcollection attribute,
...
// SpellingNameRange retrieve a range for a piece that forms the cursors spelling name.
...
// GetCursorReferenced for a cursor that is a reference, retrieve a cursor representing the
...
// GetCursorDefinition for a cursor that is either a reference to or a declaration
...
// SelectorIndex if the cursor points to a selector identifier in an Objective-C
...
// IsDynamicCall given a cursor pointing to a C++ method call or an Objective-C
...
// PropertyAttributes given a cursor that represents a property declaration, return the
...
// IsExternalSymbol returns non-zero if the given cursor points to a symbol marked with
...
// GetTemplateCursorKind given a cursor that represents a template, determine
...
// GetSpecializedCursorTemplate given a cursor that may represent a specialization or instantiation
...
// GetCursorReferenceNameRange given a cursor that references something else, return the source range
...
// GetCursorCompletionString retrieve a completion string for an arbitrary declaration or macro
// definition cursor.
//
// Parameter cursor The cursor to query.
//
