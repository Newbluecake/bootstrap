...
// GetTypeSpelling pretty-print the underlying type using the rules of the
...
// GetExceptionSpecificationType retrieve the exception specification type associated with a function type.
...
// GetNumArgTypes retrieve the number of non-variadic parameters associated with a
// function type.
//
...
// AlignOf return the alignment of a type in bytes as per C++[expr.alignof]
// standard.
//
...
// OffsetOf return the offset of a field named S in a record of type T in bits
...
// TemplateArgumentAsType returns the type template argument of a template class specialization
// at given index.
//
