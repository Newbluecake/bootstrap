...
const (
	...
	// Cursor_CXXParenListInitExpr expression that references a C++20 parenthesized list aggregate initializer.
	Cursor_CXXParenListInitExpr = C.CXCursor_CXXParenListInitExpr
	// Cursor_LastExpr expression that references a C++20 parenthesized list aggregate initializer.
	Cursor_LastExpr = C.CXCursor_LastExpr
	// Cursor_FirstStmt expression that references a C++20 parenthesized list aggregate initializer.
	...
	// Cursor_OMPErrorDirective openMP error directive.
	Cursor_OMPErrorDirective = C.CXCursor_OMPErrorDirective
	// Cursor_LastStmt openMP error directive.
